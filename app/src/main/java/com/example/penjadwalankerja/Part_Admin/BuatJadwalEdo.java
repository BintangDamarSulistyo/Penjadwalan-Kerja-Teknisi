...
public class BuatJadwalEdo extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buat_jadwal_edo);
    ...
    private void showDateDialog(){
        ...
        final CustomerEdo customeredo = (CustomerEdo) getIntent().getSerializableExtra("data");

        if (customeredo != null) {
            etNamaPelanggan.setText(customeredo.getNamaPelanggan());
            etAlamat.setText(customeredo.getAlamat());
            etNoTelepon.setText(customeredo.getNoTelepon());
            etTimeResult.setText(customeredo.getTimeResult());
            etDateResult.setText(customeredo.getDateResult());
            btSave.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    customeredo.setNamaPelanggan(etNamaPelanggan.getText().toString());
                    customeredo.setAlamat(etAlamat.getText().toString());
                    customeredo.setNoTelepon(etNoTelepon.getText().toString());
                    customeredo.setTimeResult(etTimeResult.getText().toString());
                    customeredo.setDateResult(etDateResult.getText().toString());

                    updateCustomer(customeredo);
                }
            });
        } else {
            btSave.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(!isEmpty(etNamaPelanggan.getText().toString()) && !isEmpty(etAlamat.getText().toString()) && !isEmpty(etNoTelepon.getText().toString()) && !isEmpty(etTimeResult.getText().toString())&& !isEmpty(etDateResult.getText().toString()))
                        submitCustomer(new CustomerEdo(etNamaPelanggan.getText().toString(), etAlamat.getText().toString(), etNoTelepon.getText().toString(), etTimeResult.getText().toString(), etDateResult.getText().toString()));
                    else
    ...
    private void updateCustomer(CustomerEdo customeredo) {
        /**
         * Baris kode yang digunakan untuk mengupdate data customer
         * yang sudah dimasukkan di Firebase Realtime Database
         */
        database.child("Edo") //akses parent index, ibaratnya seperti nama tabel
                .child(customeredo.getKey()) //select customer berdasarkan key
                .setValue(customeredo) //set value customer yang baru
    ...
    private void submitCustomer(CustomerEdo customeredo) {
        /**
         * Ini adalah kode yang digunakan untuk mengirimkan data ke Firebase Realtime Database
         * dan juga kita set onSuccessListener yang berisi kode yang akan dijalankan
         * ketika data berhasil ditambahkan
         */
        database.child("Edo").push().setValue(customeredo).addOnSuccessListener(this, new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void aVoid) {
    ...
    public static Intent getActIntent(Activity activity) {
        ...
        return new Intent(activity, BuatJadwalEdo.class);
    }
}
