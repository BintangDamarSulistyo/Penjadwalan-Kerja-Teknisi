...
public class MenuUserEdo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_user_edo);

        _cvlihat = (CardView) findViewById(R.id.cvlihat);
        _cvtentang = (CardView) findViewById(R.id.cvabout);

        _cvlihat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MenuUserEdo.this, LihatJadwalEdo.class);
        ...
        _cvtentang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MenuUserEdo.this, Tentang.class);
                startActivity(intent);
            }
        });
